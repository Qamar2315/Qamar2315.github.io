document.addEventListener('DOMContentLoaded', () => {
    ...
    function populateModal(item) {
        ...
        if (item.long_description) {
            let processedDesc = item.long_description;
            // Handle double-escaped newlines and replace escaped asterisks
            if (typeof processedDesc === 'string') {
                processedDesc = processedDesc.replace(/\\n/g, '\n');
                processedDesc = processedDesc.replace(/\\\*/g, '*');
            }
